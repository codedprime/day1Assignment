(function(){
  'use strict';
  var run = require("../app/aritGeo.js");
  var aritGeo = run.aritGeo;
  ...
  describe("Determine the sequence of an array of numbers: ", function() {
    ...
    describe("Case for neither arithmetic nor geometric sequence", function() {
      ...
      it("should return -1 for [8, 8, 27, 64, 125]", function() {
        expect(aritGeo([8, 8, 27, 64, 125])).toEqual(-1);
      });
